...
const SideBar = React.forwardRef((props, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={`sidebar overflow-y-auto absolute -traslate-x-0 md:relative right:0 w-[18%] max-w-[300px] min-w-[250px] h-full bg-[#fff] pt-8 px-4 overflow-auto  z-50 ${
        !showNav && "-translate-x-[-100%] opacity-0"
      }`}
    >
      <h1 className="pb-3 text-3xl font-bold ">
        <span className="text-primary">APP</span> Movie{" "}
      </h1>
